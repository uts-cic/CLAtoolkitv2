...
class TrelloImporter(object):
    ...
    xapi_objects = [xapi_settings.OBJECT_NOTE, xapi_settings.OBJECT_TASK, xapi_settings.OBJECT_COLLECTION,
                    xapi_settings.OBJECT_PERSON, xapi_settings.OBJECT_FILE, xapi_settings.OBJECT_CHECKLIST_ITEM,
    ...
    VERB_OBJECT_MAPPER = {
        ...
        xapi_settings.VERB_ADDED: [ACTION_TYPE_ADD_ATTACHMENT_TO_CARD, ACTION_TYPE_ADD_CHECKLIST_TO_CARD,
                                   ACTION_TYPE_ADD_MEMBER_TO_CARD],
    ...
    def perform_import(self):
        trello_board = self.TrelloCient.get_board(self.retreival_param)
        ...
        self.import_TrelloActivity(trello_board.actions, self.unit)
    ...
    def get_object_diaplay_value(self, stmt):
        ...
        if action == self.ACTION_TYPE_CREATE_CARD:
            ...
            self.italicize(object_val), self.italicize(contexts[index]['definition']['name']['en-US']))
            ...
            value = "%s: %s" % (
            self.italicize(contexts[index]['definition']['name']['en-US']), self.italicize(object_val))
